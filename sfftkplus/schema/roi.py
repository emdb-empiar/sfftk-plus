...
#
# Generated Wed Jul 11 10:26:09 2018 by generateDS.py version 2.29.14.
...
#   ('-o', 'sfftkplus/schema/roi.py')
#
# Command line arguments:
#   sfftkplus/schema/roi.xsd
#
# Command line:
#   /Users/pkorir/miniconda2/envs/sfftk-0.7/bin/generateDS.py -o "sfftkplus/schema/roi.py" sfftkplus/schema/roi.xsd
#
...
class ROI(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ROI', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ROI')
...
class orientedContourType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='orientedContourType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('orientedContourType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class image_idsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='image_idsType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('image_idsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='image_idsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.top is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<top>%s</top>%s' % (self.gds_format_integer(self.top, input_name='top'), eol_))
        if self.front is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<front>%s</front>%s' % (self.gds_format_integer(self.front, input_name='front'), eol_))
        if self.right is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<right>%s</right>%s' % (self.gds_format_integer(self.right, input_name='right'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
