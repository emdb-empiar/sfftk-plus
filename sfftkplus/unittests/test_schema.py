...
class TestSFFPSegmentation(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.hff_file = os.path.join(tests.TEST_DATA_PATH, 'test_emd_1832.hff')
        cls.json_file = os.path.join(tests.TEST_DATA_PATH, 'test_emd_1832.json')
    ...
    def test_as_vtk(self):
        ...
        sff_segmentation = SFFPSegmentation(self.sff_file)
        vtk_segmentation = sff_segmentation.as_vtk(args)
