    ...
    def read(self):
        ...
        try:
            ...
            try:
                ...
                print_date("Invalid value for var CONNECT_WITH: {}; must be one of: {}".format(self['CONNECT_WITH'],
                                                                                               ", ".join(
                                                                                                   connect_with_values)))
        except AssertionError:
            print_date(
                "CONNECT_WITH not found in current configs (with value: {}".format(", ".join(connect_with_values)))
